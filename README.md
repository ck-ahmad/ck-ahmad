...
<h3 align="center">Data Analyst Intern | AI & ML Enthusiast | Python Developer from Pakistan</h3>
...
<!--   https://www.vitaely.me/portfolio_ahmad0763 -->
  ...
  <a href="https://github.com/ck-ahmad/ck-ahmad/blob/main/Ahmad_Resuma.docx" target="_blank">
...
**Databases:**  
![MySQL](https://img.shields.io/badge/-MySQL-005C84?style=flat&logo=mysql)  ![MongoDB](https://img.shields.io/badge/-MongoDB-47A248?style=flat&logo=mongodb&logoColor=white)  ![Oracle](https://img.shields.io/badge/-Oracle-F80000?style=flat&logo=oracle&logoColor=white)  
...
|--------|-------------|------------|
| [🪐 AstroHub](https://github.com/ck-ahmad/AstroHub) | GitHub-style portfolio with authentication | Flask, MySQL |
| [🧠 AI Assistant](https://github.com/ck-ahmad/AI-Assistant) | Voice-controlled NLP assistant | Python, OpenAI, TTS |
| [🎵 Galaxify](https://github.com/ck-ahmad/Galaxify) | Spotify-style media player | Flask, JS, HTML/CSS |
| [📊 Personal Portfolio](https://github.com/ck-ahmad/Portfolio) | Personal Portfolio | Python, Flask, HTML, CSS, JS |
...
- **Oasis Infobyte** – Python Intern _(Jul 2025 – Aug 2025)_  
  Built CLI tools and automation scripts

- **Codveda** – Python Intern _(Jul 2025 – Aug 2025)_  
  API dev, CLI utilities, speech-based utilities

- **CodeAlpha** – Python Intern _(Jun 2025 – Jul 2025)_  
  Flask apps, games, AI chatbot (voice + greeting)
...
- 🥉 3rd Place – Devpost Hackathon (2024)
- 🎓 Participant – IIT Kanpur TechFest (2024)
- ✅ Python for Everybody – UMich
- ✅ Flask – freeCodeCamp
- ✅ Data Analyst Track – freeCodeCamp
- ✅ SQL & DBMS – freeCodeCamp
- ✅ ML for All – University of London

---

### ✍️ Blogs & Tutorials *(Coming Soon)*

- [ ] How I built a Personal AI Assistant using Python  
- [ ] Flask vs Django – When to choose what?  
- [ ] Complete EDA with Pandas & Seaborn  
